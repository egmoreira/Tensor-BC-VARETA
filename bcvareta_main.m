function [SigmaJJ_graph,XJJ_graph,SigmaJJ] = bcvareta_main(Svv,K,Nsamp)
...
%    Nsamp         : cell array containing the sample number of all subjects
%                    EEG/MEG time series cross spectra
%
% outputs:
...
for cont1 = 1:maxiter
    ...
    for cont2 = 1:Nsubj
        ...
        for cont3 = 1:Nf
            ...
            sigmae2_plus = trace(SigmaVVinv{cont2}*A*Svv{cont2}(:,:,cont3)*A')/p{cont2}+trace(Kt{cont2}*SigmaVVinv{cont2}*K{cont2}*SigmaJstJst)/p{cont2}+asigmae2;
    ...
    for cont2 = 1:Nsubj
        for cont3 = 1:Nf
            [lf_plus] = bcvareta_likelihood_est(S_short,U_short,V_short,sigmae2,Svv{cont2}(:,:,cont3),T,A,Nsamp,p{cont2},asigmae2);
